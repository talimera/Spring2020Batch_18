 ...
 */
public class replit_033_Citizens {

    public static void main(String[] args) {

        Scanner scan = new Scanner(System.in);

        System.out.println("Enter current count for Senior Citizens and Non-Citizens respectively");
        ...
        if(age>= 65){
            System.out.println("New citizen is Senior ");
            seniorCitizens = ++seniorCitizens;
        }else{
            System.out.println("New citizen is Non-Senior");
            nonSeniorCitizens = ++nonSeniorCitizens;
        }

        System.out.println("New Senior Citizen Count is "+ seniorCitizens);
        System.out.println("New Non-Senior Citizen Count is "+ nonSeniorCitizens);
